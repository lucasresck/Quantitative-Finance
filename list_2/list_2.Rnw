          ...
          \item
            ...
            \begin{itemize}
              ...
              \item Se $\xi = 0$:
                ...
                Para a dist. exponencial, $E(L \mid L \ge VaR_\alpha) = (1 - \log\alpha)/r=1 - \log\alpha$. Para a dist. de Pareto, $E(L \mid L \ge VaR_\alpha) = 1-\log\alpha$. Ou seja, são iguais. Note que isso era esperado, pois tomamos $r = 1$, de modo que nossa exponencial tem taxa $1$, assim como a GPD com $\xi = 0$, $m = 0$ e $\lambda = 1$.
...
@
        ...
        O Q-Q plot indica que os dados do PCS possuem distribuição muito semelhante à dos dados.
...
@
        ...
        Como o p-valor é muito baixo, rejeitamos a hipótese de que os dados possuem mesma distribuição. Ou seja, de que o PCS possui distribuição GPD.
